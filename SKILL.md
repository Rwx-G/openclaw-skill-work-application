...
This skill stores **no secrets**. Config contains only behavioral flags and defaults. No API keys, tokens, or passwords are required for any feature. Playwright runs without authentication.
